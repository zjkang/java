...
// https://www.youtube.com/watch?v=eVv2CLoaRTw&list=PLmOn9nNkQxJG_AbAUeyAPH3fO0i_APAM9&index=117
...
Static Season valueOf(String name): convert name to enum type; the name must be enum type name 'SPRING', otherwise throw illegalArgumentException
String name(): Season.SPRING.name() return 'SPRING'
int ordinal(): Season.AUTUMN.ordinal(): return the order of enum AUTUMN;

// enum
1. enum type can implments an interface; override interface abstract method;
2. enum type can implments an interface; override interface abstract method for each enum type object;
